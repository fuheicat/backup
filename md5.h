...
class MD5 {
    ...
    static constexpr unsigned int A = 0x67452301;
    static constexpr unsigned int B = 0xefcdab89;
    static constexpr unsigned int C = 0x98badcfe;
    static constexpr unsigned int D = 0x10325476;
